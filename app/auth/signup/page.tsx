    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-900 to-purple-900 px-4 py-12">
      <Card className="w-full max-w-md border-indigo-700/50 bg-slate-900/90 backdrop-blur-sm">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-slate-300">Sign up to get started with EduTube</CardDescription>
        </CardHeader>
            ...
            >
              ...
              {error.isWarning && (
                <div className="mt-2 text-sm">
                  <Link href="/auth/signin" className="text-amber-200 hover:underline">
                    Go to sign in page →
                  </Link>
                </div>
              )}
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <p className="text-sm text-center text-slate-300">
            ...
            <Link href="/auth/signin" className="text-indigo-400 underline-offset-4 hover:underline">
              Sign in
            </Link>
          </p>
        </CardFooter>
