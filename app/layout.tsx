...
export const metadata: Metadata = {
  title: "xGuru - YouTube-Powered Educational Platform",
  description:
    "Launch, manage, and monetize your video courses without paying for video hosting",
  generator: "v0.dev",
                                ...
                                <React.Suspense fallback={null}>
                                  ...
                                  {(() => {
                                    const MobileSidebarToggle =
                                      require("@/components/mobile-sidebar-toggle").MobileSidebarToggle;
