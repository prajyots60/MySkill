    ...
    <div className="flex flex-col min-h-screen relative overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection animation="fade-up">
            ...
            <p className="text-xl text-center text-muted-foreground max-w-2xl mx-auto mb-10">
              Join thousands of students and instructors on the premium
              educational platform powered by YouTube integration for seamless
      ...
      <section className="py-10 bg-gradient-to-r from-indigo-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center relative z-10">
            ...
            >
              <span className="text-4xl md:text-5xl font-bold mb-2 neon-text">
                10K+
              </span>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mt-16">
            {[
              ...
              {
                icon: <BarChart className="h-10 w-10 mb-2" />,
                name: "Business",
                count: 85,
                color: "blue",
              },
              {
                icon: <Zap className="h-10 w-10 mb-2" />,
                name: "IT & Software",
                count: 75,
                color: "cyan",
              },
                  ...
                  >
                    <div className="flex flex-col items-center justify-center text-center h-full">
                      <div
                        ...
                        style={{
                          color: `var(--${category.color}-500, #6366f1)`,
                        }}
                      >
                        {category.icon}
                      </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <AnimatedSection animation="fade-up" delay={0.1}>
              ...
              >
                <p>
                  Our platform handles all the technical details. Your content
                  is securely stored on YouTube but fully managed through our
                  interface.
                </p>
            ...
            <AnimatedSection animation="fade-up" delay={0.2}>
              ...
              >
                <p>
                  Organize your content into a structured learning experience
                  with sections, lectures, and additional resources.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-center gap-2">
                    <Check className="h-5 w-5 text-green-500" />
            ...
            <AnimatedSection animation="fade-up" delay={0.3}>
              ...
              >
                <p>
                  Easily share your courses with students. Track engagement and
                  grow your audience with our built-in tools.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-center gap-2">
                    <Check className="h-5 w-5 text-green-500" />
      ...
      <section className="py-20 px-4 md:px-6 bg-gradient-to-b from-indigo-900/20 to-purple-900/20 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center">
          <AnimatedSection animation="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-indigo-400 to-purple-500 text-transparent bg-clip-text">
              Ready to Transform Your Teaching?
            </h2>
            <p className="max-w-2xl mx-auto mb-8 text-muted-foreground">
              Join thousands of creators who are sharing their knowledge with
              the world. No technical skills required. No video hosting costs.
              Start teaching today and reach students globally.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-md mx-auto">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
            ...
            >
              <div className="bg-indigo-500/20 rounded-full w-16 h-16 flex items-center justify-center mb-3 ring-4 ring-indigo-500/10">
                <Video
                  className="h-8 w-8"
                  style={{ color: "var(--indigo-500, #6366f1)" }}
                />
              </div>
            ...
            >
              <div className="bg-purple-500/20 rounded-full w-16 h-16 flex items-center justify-center mb-3 ring-4 ring-purple-500/10">
                <Users
                  className="h-8 w-8"
                  style={{ color: "var(--purple-500, #a855f7)" }}
                />
              </div>
