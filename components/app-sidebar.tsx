...
export function AppSidebar() {
  ...
  const { connected: youtubeConnected, checkConnectionStatus } =
    useYouTubeStore();
  ...
  return (
    <Sidebar collapsible="icon" className="sidebar-modern">
      ...
      <SidebarContent className="px-1">
        ...
        {!isAuthenticated && (
          <SidebarGroup>
            <SidebarGroupLabel className="text-[11px] px-1">
              Navigation
            </SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  ...
                  >
                    <PrefetchableLink href="/" instantHoverLoad={true}>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    className="group-data-[collapsible=icon]:justify-center"
                  >
                    <PrefetchableLink href="/explore" instantHoverLoad={true}>
        ...
        {isAuthenticated && (
          <>
                  ...
                  <SidebarMenu>
                    ...
                    <SidebarMenuItem>
                      <SidebarMenuButton
                        asChild
                        isActive={isActive(
                          "/dashboard/student/followed-creators"
                        )}
                        tooltip="Followed Creators"
                        className="group-data-[collapsible=icon]:justify-center"
                      >
                        <Link
                          href="/dashboard/student/followed-creators"
                          prefetch={true}
                          scroll={false}
                        >
            ...
            {userRole === "ADMIN" && <SidebarSeparator className="my-2" />}
                ...
                <SidebarGroupContent>
                  <SidebarMenu>
                    ...
                    <SidebarMenuItem>
                      ...
                      >
                        <Link
                          href="/dashboard/creator/content/create"
                          prefetch={true}
                          scroll={false}
                        >
                    ...
                    <SidebarMenuItem>
                      ...
                      >
                        <Link
                          href="/dashboard/creator/add-student"
                          prefetch={true}
                          scroll={false}
                        >
                          <Users className="h-4 w-4" />
