    ...
    <section className="py-16 px-4 md:px-6">
      <div className="container mx-auto">
        <div className="flex justify-between items-center mb-10">
          <h2 className="text-gradient-luxe text-3xl font-bold">
            Featured Courses
          </h2>
          <Button asChild className="btn-luxe-secondary">
            <Link href="/explore">
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 right-3 flex gap-2">
                      {course.price === 0 && (
                        <span className="status-success px-2 py-1 text-white text-xs rounded-full">
                          Free
                        </span>
                      )}
                      {course.isTrending && (
                        <span className="status-warning px-2 py-1 text-white text-xs rounded-full flex items-center">
                  ...
                  <CardHeader>
                    <CardTitle className="text-gradient-luxe line-clamp-1">
                      {course.title}
                    </CardTitle>
